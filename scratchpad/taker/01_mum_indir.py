#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""taker kapisi olcumu — ILERI FIYAT icin 1h mum indirici.

ON_KAYIT_taker_kapisi.md bolum 12 · commit 08c8876 (KOSMADAN once yazildi)
...
CIKTI = os.path.join(KOK, "scratchpad", "taker", "klines")
...
def hucre_sembolleri():
    """On-kayit bolum 3'teki suzgec. Yalniz SEMBOL listesi dondurur."""
...
def main():
    ...
    print("=" * 80)
    print("TAKER OLCUMU — ileri fiyat mumlari (on-kayit 08c8876)")
    print("=" * 80)
    print("hedef hucre sembolu : %d" % len(syms))
